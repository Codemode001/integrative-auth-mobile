...
import 'package:integrative/auth/signup.dart';
import 'package:integrative/profile.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              SizedBox(height: 50),
              Image.network(
                'https://res.cloudinary.com/dhhamkkue/image/upload/v1713532456/1_lo3egx.png',
                height: 100,
              ),
              SizedBox(height: 20),
              SizedBox(height: 20),
